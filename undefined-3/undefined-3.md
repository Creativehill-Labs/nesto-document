...
Nesto 운영의 중심에는 Core Contributor 팀이 관리하는 Treasury가 있습니다. 우리의 NEFI 토큰은 나중에 사용하기 위해 예약된 토큰 없이 완전히 배포되기 때문에 우리의 전체 운영은 지속적인 수익 창출 활동으로 자금을 조달합니다. 조명을 켜고 Vault 자동 합성을 유지하기 위해 Nesto는 DAO의 최대 이익을 염두에 두고 책임감 있게 재무부 사용을 관리하기 위해 재무 팀의 지속적인 경계에 의존합니다.
